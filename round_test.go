...
func TestMathRound(t *testing.T) {
	...
	b = epsilonEqual(float64(minInt)-1.0, Round(float64(minInt)-0.6, 0, RoundHalfUp))
	if !b {
		t.Fatal(b)
	}

	b = epsilonEqual(float64(minInt), Round(float64(minInt)-0.4, 0, RoundHalfUp))
	if !b {
		t.Fatal(b)
	}
	b = epsilonEqual(float64(minInt), Round(float64(minInt)+0.4, 0, RoundHalfUp))
	...
	b = epsilonEqual(float64(minInt)+1, Round(float64(minInt)+0.6, 0, RoundHalfUp))
	if !b {
		t.Fatal(b)
	}
	...
	b = epsilonEqual(float64(maxInt)-1, Round(float64(maxInt)-0.6, 0, RoundHalfUp))
	if !b {
		t.Fatal(b)
	}
	b = epsilonEqual(float64(maxInt), Round(float64(maxInt)-0.4, 0, RoundHalfUp))
	if !b {
		t.Fatal(b)
	}
	b = epsilonEqual(float64(maxInt), Round(float64(maxInt)+0.4, 0, RoundHalfUp))
